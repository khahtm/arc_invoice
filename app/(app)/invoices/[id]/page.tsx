...
export default function InvoiceDetailPage({
  ...
  const { canAutoRelease } = useEscrowStatus(
    ...
    <div className="max-w-2xl mx-auto space-y-8">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <InvoicePdfDownload invoice={invoice} size="icon" />
        ...
        <div className="grid grid-cols-2 gap-4">
          ...
          <div>
            ...
            <p className="font-semibold capitalize">
              {invoice.payment_type === 'direct' ? 'Instant Pay' : 'Protected Pay'}
            </p>
          </div>
        </div>
      ...
      {invoice.payment_type === 'escrow' && !invoice.escrow_address && isCreator && (
      ...
      {invoice.payment_type === 'escrow' && invoice.escrow_address && (
        <Card className="p-6 space-y-4">
          ...
          {invoice.status === 'funded' && isCreator && (
