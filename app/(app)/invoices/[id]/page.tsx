...
import { ProofSubmit, MilestoneProofSubmit } from '@/components/invoice/ProofSubmit';
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      {!hasMilestones && invoice.status !== 'pending' && (
        <ProofSubmit
          ...
          currentProofUrl={invoice.proof_url}
          onSuccess={(proofUrl) =>
            setInvoice((prev) => (prev ? { ...prev, proof_url: proofUrl } : null))
          }
        />
      )}
